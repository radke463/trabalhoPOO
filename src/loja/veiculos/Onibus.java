...
public class Onibus extends Veiculo{
	...
	/**
	* Construtor do onibus. Verificar o construtor de Veiculos para melhor entedimento
	* @see Veiculo#Veiculo(int, int, double, double, double, double, String, String, String, Boolean)
	* @param ano Representa o ano do veículo
	* @param marchas Representa a quantidade de marchas do veículo
	...
	* @author Rodrigo Ricardo Radke
	*/
	public Onibus(int ano, int marchas, double valor, double km, double cilindradas, double potencia, String marca, String modelo,
